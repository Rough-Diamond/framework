...
@WebServiceClient(name = "SampleService", 
                  wsdlLocation = "file:/D:/products/rdf/fwws/framework/trunk/framework/etc/wsdl/SampleService.wsdl",
...
public class SampleService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/products/rdf/fwws/framework/trunk/framework/etc/wsdl/SampleService.wsdl");
        } catch (MalformedURLException e) {
            System.err.println("Can not initialize the default wsdl from file:/D:/products/rdf/fwws/framework/trunk/framework/etc/wsdl/SampleService.wsdl");
            // e.printStackTrace();
        }
        WSDL_LOCATION = url;
    }
